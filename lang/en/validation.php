...
return [
    ...
    */
    ...
    'confirmed' => 'O campo de confirmação de senha não está correto.',
    ...
    'max' => [
        ...
        'string' => 'O campo senha não deve ser maior que :max caracteres.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para trocar nosso espaço reservado de atributos
    | por algo mais compreensível, como "Endereço de E-mail" em vez de "email". Isso ajuda simplesmente a tornar nossa mensagem mais expressiva.
    |
    */
